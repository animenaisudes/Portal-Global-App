...
def show_portal_frame():
    ...
    try:
        ...
        if P_hor > 0:
            ...
            # Perbaikan: Mengurangi koordinat Y (nodes[2][1]) sebesar 0.15 untuk menggeser teks ke bawah
            ...
            ax.text(arrow_start_x + 0.9, text_y_position, f'P={P_hor:.1f} kN', 
                    color='red', ha='left', va='center', fontsize=12, fontweight='bold', zorder=3)
